...
export default function Jewellery() {
    ...
    <h1 className="lg:text-4xl text-2xl font-extrabold ml-2 mb-5 dark:text-white ">Menu</h1>
        <button className="lg:text-xl text-l p-3 font-bold hover:text-white border-b-2 text-start border-black cursor-pointer  dark:hover:text-black dark:text-white dark:border-white" onClick={()=> filterProduts("Rings")}>Rings</button>
        <button className="lg:text-xl text-l p-3 font-bold hover:text-white border-b-2 text-start border-black cursor-pointer  dark:hover:text-black dark:text-white dark:border-white " onClick={()=> filterProduts("Chains")}>Chains</button>
