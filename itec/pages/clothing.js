...
export default function Clothing() {
    ...
    <div className="lg:flex lg:flex-row flex-col p-5 space-x-5 mt-3">
      ...
      <div className="flex flex-col gap-5 bg-gray-300 p-10 rounded-2xl shadow-lg lg:w-[20%] w-[100%] mb-10 lg:fixed top-36 left-5 z-10">
        ...
        <button className="lg:text-xl text-l p-3 font-bold hover:text-white border-b-2 text-start border-black cursor-pointer  dark:hover:text-black dark:text-black" onClick={()=> filterProduts("T-shirt")}>T-shirts</button>
